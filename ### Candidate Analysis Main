...
### Step 4: Input training data into learning algorithm
### O(n)


### Step 5: Output learning algorithm
### O(n)


### Step 6: Input testing list into learning algorithm
### O(n)


### Step 7: Output model accuracy
### O(n)
